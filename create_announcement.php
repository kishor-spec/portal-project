            ...
            <div class="card-body p-4">
                <form action="process_announcement.php" method="POST">
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" class="form-control shadow-none" placeholder="e.g., Holiday Notice" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold small text-uppercase text-muted">Detailed Message</label>
                        <textarea name="message" class="form-control shadow-none" rows="6" placeholder="Type the announcement details here..." required></textarea>
                    </div>

                    <div class="mb-4">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="activeSwitch" checked>
                            <label class="form-check-label fw-medium" for="activeSwitch">Make this announcement active immediately</label>
                        </div>
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-success px-4">Post Announcement</button>
